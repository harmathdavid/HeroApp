...
{
    [TestClass]
    public class HorseManFightTest : BaseHeroFightTest
    {
        [TestMethod]
        public override void AttackArcher()
        {
            IHero hero = new HorseMan(1);
        ...
        public override void DefenseArcher()
        {
            ...
            Assert.IsTrue(average <= 70 && average >= 50);
        }
